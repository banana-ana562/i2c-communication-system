 ...
 *		Author: Jackie Huynh
 * Modified by: Ana Arante, Emily Hsu, Suphia Sidiqi
 *
 */
#ifndef MPU6050_H_
#define MPU6050_H_
...
#define SMPLRT_DIV							(0x19) // Sample Rate to 1kHz
//	#define SMPLRT_DIV_1					()
//	#define SMPLRT_DIV_2					()
//	#define SMPLRT_DIV_3					()
//	#define SMPLRT_DIV_4					()
...
//	#define SMPLRT_DIV_6					()
//	#define SMPLRT_DIV_7					()
	#define SMPLRT_DIV_8					(0x00) // Sample Rate = Gyroscope Output Rate / (1 + SMPLRT_DIV)

/****************Config Register****************/
#define CONFIG									(0x1A)
	#define CONFIG_DFPL_0					(0x00)
...
#define PWR_MGMT_1          		(0x6B)
	#define PWR_CLK_SEL_INTERNAL	(0x00)
